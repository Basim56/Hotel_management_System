...
public class RoomUI {
    ...
    public RoomUI(){
        ...
        String data[][]=roomService.getAllroomsforJtable();
        String column[]={"ROOM ID","CATEGORY","ROOM FLOOR","PRICE","HOTEL ID","URL"};
        ...
        search.addKeyListener(new KeyListener() {
            ...
            public void keyReleased(KeyEvent e) {
                String[][] data= roomService.getRoombyCategory(search.getText());
        ...
        delete.addActionListener(e->{
            if(table.getSelectedRow()!=-1) {
                ...
                String roomid= (String) table.getValueAt(id,0);
